...
namespace CarsManagment
{
    public partial class Cars : Form
    {
        ...
        public Cars(CarsMainForm carsMainForm)
        {
            try
            {
                InitializeComponent();
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
                carsMainForm.bindRecordCarForm(this);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                carsMainForm.bindUpdateCarForm(carRow, this);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void btnReport_Click(object sender, EventArgs e)
        {
            try
            {
                carsMainForm.bindReportCarsForm(gridControlStores);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void btnCarPapers_Click(object sender, EventArgs e)
        {
            ...
            {
                DataRowView carRow = (DataRowView)(((GridView)gridControlStores.MainView).GetRow(((GridView)gridControlStores.MainView).GetSelectedRows()[0]));
                carsMainForm.bindCarPaperForm(carRow, this);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void btnCarDrivers_Click(object sender, EventArgs e)
        {
            ...
            {
                DataRowView carRow = (DataRowView)(((GridView)gridControlStores.MainView).GetRow(((GridView)gridControlStores.MainView).GetSelectedRows()[0]));
                carsMainForm.bindCarDriversForm(carRow, this);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void btnSpareParts_Click(object sender, EventArgs e)
        {
            ...
            {
                DataRowView carRow = (DataRowView)(((GridView)gridControlStores.MainView).GetRow(((GridView)gridControlStores.MainView).GetSelectedRows()[0]));
                carsMainForm.bindSparePartForm(carRow, this);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void btnCarLicense_Click(object sender, EventArgs e)
        {
            ...
            {
                DataRowView carRow = (DataRowView)(((GridView)gridControlStores.MainView).GetRow(((GridView)gridControlStores.MainView).GetSelectedRows()[0]));
                carsMainForm.bindCarLicenseForm(carRow, this);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
