...
namespace CarsManagment
{
    public partial class CarExpensesType : Form
    {
        ...
        private void txtType_TextChanged(object sender, EventArgs e)
        {
            try
            {
                string query = "select ID as 'كود',Type as 'انواع المصروفات' from expenses_type where Type like'" + txtType.Text + "%'";
            ...
            try
            {
                ...
                if (type != null)
                {
                    ...
                    if (dialogResult == DialogResult.Yes)
                    {
                        ...
                        string query = "delete from expenses_type where ID=" + type[0].ToString();
        ...
        {
            string query = "select ID as 'كود', Type as 'انواع المصروفات' from expenses_type";
        ...
        {
            string query = "select ID from expenses_type where Type='" + txtType.Text + "'";
            MySqlCommand com = new MySqlCommand(query, dbconnection);
            if (com.ExecuteScalar() == null)
            {
                query = "insert into expenses_type  (Type)values(@Type)";
