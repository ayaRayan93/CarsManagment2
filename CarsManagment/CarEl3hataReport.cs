...
{
    public partial class CarEl3hataReport : Form
    {
        GridControl gridControl;
        public CarEl3hataReport(GridControl gridControl)
        {
            InitializeComponent();
            this.gridControl = gridControl;
        }

        private void CarEl3hataReport_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        private void PrintableComponentLink_CreateReportHeaderArea(object sender, DevExpress.XtraPrinting.CreateAreaEventArgs e)
        {
            ...
            Image pageImage = CarsManagment.Properties.Resources.Logo3;
            ...
            string devexpress = "تقرير السيارات";
            // Specify required settings for the brick graphics.
