...
namespace CarsManagment
{
    public partial class SparePart : Form
    {
        ...
        public SparePart(CarsMainForm carsMainForm)
        {
            try
            {
                InitializeComponent();
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            try
            {
               carsMainForm.bindRecordSparePartForm(this);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                carsMainForm.bindUpdateSparePartForm(carRow, this);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
        ...
        private void btnReport_Click(object sender, EventArgs e)
        {
            try
            {
                carsMainForm.bindReportSparePartForm(gridControlStores);
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message);
